...
public class BTRefresh {
   ...
   /* public static void main(String[] args) throws IOException, InterruptedException {
    	new BTServicesSearcher();
		
	}*/

    public void methodRefresh(MyDialog dialog) throws IOException, InterruptedException {
        ...
        DiscoveryListener listener = new DiscoveryListener() {
            ...
            public void servicesDiscovered(int transID, ServiceRecord[] servRecord) {
                ...
                for (int i = 0; i < servRecord.length; i++) {
                    ...
                    BTRefresh.dialog.addItem(new BTDevice(tempDeviceName,url));
                }
            }
        ...
        dialog.setStatus("Refresh finished. Send a message");
