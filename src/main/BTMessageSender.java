...
public class BTMessageSender {
	...
	public static boolean  sendMessage(String deviceBTURL, String message, MyDialog dialog, String name){
		...
		try{
			 ...
			 dialog.setLog("Last Session Conducted with Device: \n" + deviceBTURL+"\nMessage Info: " + message +"\nDevice Name: "+name);
			 ...
			 if (hsConnectReply.getResponseCode() != ResponseCodes.OBEX_HTTP_OK) {
		            ...
		            dialog.setLog("Failed to connect");
		            return false;
		      }
			 
			 // 3. create the PUT operation
			 HeaderSet hsOperation = clientSession.createHeaderSet();
		     hsOperation.setHeader(HeaderSet.NAME, "BR.txt");
